...
const op = { 'hash': { 'short': hashShort.stdout.toString().trim(), 'long': hash }, 'tag': tagCmd.stdout.toString().trim(), 'version': readJsonSync('./package.json').version };

const file = resolve(__dirname, '..', 'src', 'environments', 'buildinfo.ts');
